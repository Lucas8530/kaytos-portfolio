...
var Traverse = /** @class */ (function () {
    ...
    Traverse.prototype.combineLeftJsxNodes = function (jsxNodes, parent) {
        ...
        var end = tslib.__assign({}, last(jsxNodes).position.end);
        // fix #279
                ...
                if (isOpenTag(value)) {
                    ...
                    if (!offset) {
                        ...
                        if (firstOpenTagIndex === -1) {
                            ...
                            acc.push.apply(acc, tslib.__spreadArray(tslib.__spreadArray([], jsxNodes.slice(0, firstOpenTagIndex)), [_this.combineLeftJsxNodes(jsxNodes.slice(firstOpenTagIndex), parent)]));
                        }
                        jsxNodes.length = 0;
                    }
                }
...
var mdProcessor = unified__default['default']().use(remarkParse__default['default']).freeze();
var mdxProcessor = mdProcessor().use(remarkMdx__default['default']).freeze();
...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.normalizeJsxNode = function (node, parent, options) {
        ...
        if (commentContent) {
            ...
            Object.assign(node, {
                data: tslib.__assign(tslib.__assign({}, data), { jsxType: 'JSXElementWithHTMLComments', comments: comments_1, 
    ...
    Parser.prototype.parseForESLint = function (code, options) {
        var _this = this;
        var extname = path__default['default'].extname(options.filePath);
